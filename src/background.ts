...
// Receives a "DEFINE" message from the content script, calls the Gemini API
// with the selected word/phrase plus surrounding context, and returns a
// short definition.
...
async function getApiKey(): Promise<string | undefined> {
  ...
  return stored.geminiApiKey as string | undefined;
}
...
chrome.runtime.onMessage.addListener((message: DefineRequest, _sender, sendResponse) => {
